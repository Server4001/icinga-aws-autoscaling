...
module.exports = {
    ...
    createHostRequestOptions(instanceId, publicDns, instanceSize) {
        ...
        // }
        if ((typeof config.icinga_var_aws_asg_name) === 'string' && config.icinga_var_aws_asg_name.length > 0) {
            options.json.attrs['vars.aws_asg_name'] = config.icinga_var_aws_asg_name;
        }
