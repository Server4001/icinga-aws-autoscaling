 ...
 *
 * @param {Object} config
 * @property {String} icinga_host
 * @property {String} icinga_port
 * @property {String} icinga_user
 * @property {String} icinga_pass
 * @property {String} icinga_host_name_property
 * @property {Object} icinga_host_vars
 *
 * @return {Object}
 */
const icingaApi = function(config) {
    return {
        /**
         ...
         * @return {Promise}
         */
        deleteHost(instanceId, instanceData) {
            const requestOptions = this.deleteHostRequestOptions(instanceId, instanceData);
         ...
         * @return {Object}
         */
        deleteHostRequestOptions(instanceId, instanceData) {
            const hostName = this.icingaHostName(instanceId, instanceData);

            return {
                method: 'POST',
                uri: `https://${config.icinga_host}:${config.icinga_port}/v1/objects/hosts/${hostName}?cascade=1`,
                strictSSL: false,
                headers: {
                    'Accept': 'application/json',
